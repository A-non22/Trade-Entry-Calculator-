...
# ------------------- SCENARIO 1 -------------------
with col1:
    st.header("Trade Confidence Calculator (Scenario 1)")
    ...
    partial1 = st.selectbox("Partial (Total credit -3)", options=[0, 1, 2, 3], key="partial1")
    ...
    obtained_credit_1 = wdrr1 + full_set1 + partial1 + ddr1 + model1 + zero_line1 + entry_model1
    if trn1 != 'Not Applicable':
    ...
    st.header("Trade Entry Calculator (Scenario 1)")
...
# ------------------- SCENARIO 2 -------------------
with col2:
    st.header("Trade Confidence Calculator (Scenario 2)")
    ...
    partial2 = st.selectbox("Partial (Total credit -3)", options=[0, 1, 2, 3], key="partial2")
    ...
    obtained_credit_3 = wdrr2 + full_set2 + partial2 + ddr2 + model2 + zero_line2 + entry_model2
    if trn2 != 'Not Applicable':
    ...
    st.header("Trade Entry Calculator (Scenario 2)")
