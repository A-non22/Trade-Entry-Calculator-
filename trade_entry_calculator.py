...
# ------------------- Calculator 1: Trade Entry Calculator -------------------
with col1:
    ...
    optional_credit_1 = 2 if trn != 'Not Applicable' else 0
    ...
    st.markdown(f"<h3><b>Percentage of Total Credit:</b> <span style='color:green;'>{percentage_1:.2f}%</span></h3>", unsafe_allow_html=True)


# ------------------- Calculator 2: Second App -------------------
with col2:
    ...
    # Calculate for App 2
    base_total_credit_2 = 15  # As specified, total possible credit is 15 for App 2
    obtained_credit_2 = (mdrc + structure + m7_box + svp + bml + mb +
                         db + wdrc_mid + drc + limiter + ddr_zero)
    ...
    st.markdown(f"<h3><b>Percentage of Total Credit:</b> <span style='color:green;'>{percentage_2:.2f}%</span></h3>", unsafe_allow_html=True)
